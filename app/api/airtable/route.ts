...
export async function GET_ONE(recordId: string): Promise<AirtableExperimentRecord | null> {
  ...
  try {
    ...
    // Récupérer les noms des références en utilisant la nouvelle fonction resolveReferences
