...
import RiceSessionParticipate from "@/app/components/rice/invite/RiceSessionParticipate";
import { ThemeToggle } from "@/app/components/theme-toggle";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";

export default function RiceSessionParticipatePage() {
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <Tabs defaultValue="prioritization" className="w-full">
          ...
          <TabsContent value="prioritization">
            <RiceSessionParticipate sessionId={sessionId} />
          </TabsContent>
        </Tabs>
